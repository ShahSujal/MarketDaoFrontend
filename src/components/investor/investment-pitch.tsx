        ...
        <Dialog>
          ...
          <DialogContent className="sm:max-w-md">
            <DialogHeader>
              ...
              <DialogDescription>
                For each investment you have to deposite some amount of
                colletral which is 100% refundable
              </DialogDescription>
            </DialogHeader>
              ...
              <div className="flex items-center flex-col space-x-2 ">
                ...
                <div className="grid w-full max-w-sm items-center gap-1.5 my-2">
                  ...
                  <Input
                    ...
                    type="number"
                    placeholder="Value must be in Eth"
                  />
                </div>
                <div className="grid w-full max-w-sm items-center gap-1.5 my-2">
                  <Label htmlFor="profitAmountEstimation">
                    Profit Amount Estimation
                  </Label>
                  <Input
                    id="profitAmountEstimation"
                    placeholder="Value must be in Eth"
                    type="number"
                  />
                </div>
            ...
            <DialogFooter className="sm:justify-around">
              <Button
                onClick={() => {
                  formStage === EStage.Estimation
                    ? setformStage(EStage.Details)
                    : formStage === EStage.Deadline
                      ? setformStage(EStage.Estimation)
                      : setformStage(EStage.Details);
                }}
                disabled={formStage === EStage.Details}
              >
                Previous
              </Button>
              {formStage === EStage.Deadline ? (
