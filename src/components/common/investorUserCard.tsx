...
const InvestorUserCard = ({ investor }: Props) => {
  ...
  return (
    <div className="w-[300px] bg-black flex justify-between items-center flex-col h-[320px] m-3">
      ...
      <h1 className=" text-lg font-paps">{investor.name || walletAddressShortn(investor.walletAddress as Address)}</h1>
      <h3 className=" text-sm text-gray-500 text-center">{investor.bio?.slice(0, 60)}...</h3>
