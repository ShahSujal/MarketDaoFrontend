  ...
  return (
    <main className=" w-full min-h-screen  flex flex-row flex-wrap  justify-evenly ">
      <div className=" flex w-full relative h-[450px] justify-start  items-end ">
        ...
        <Image
          src={
           user?.image ? process.env.NEXT_PUBLIC_IMAGE_URL! + user.image : "https://images.unsplash.com/photo-1633332755192-727a05c4013d?q=80&w=1780&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
          }
          width={1000}
          height={1000}
          alt=""
