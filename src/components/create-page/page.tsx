...
const CreatePage = (props: Props) => {
  ...
  return (
    <main className=" bg-gradient-to-tr to-[#f5ecec30] from-[#19191a3e] h-[80vh] w-full relative ">
  

      {
      loadData.step === 0 ? <Step1 setLoadData={setLoadData} loadData={loadData}/> : <Step2 setLoadData={setLoadData} loadData={loadData}/> 
        }
    </main>
  );
};
